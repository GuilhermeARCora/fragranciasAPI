...
**Status**: Unit and integration tests to be added gradually.
...
👉 <a href="https://api.fragranciasdecor.com.br/api-docs/" target="_blank" rel="noopener noreferrer">/api-docs</a> <br>
  *(auto-generated from JSDoc comments)*

- 💼 **Postman Collection** — available at: <br>
